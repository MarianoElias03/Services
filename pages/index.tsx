  ...
  return (
    <>
      <main className=''>
        ...
        <div className="carousel align-items-center mb-5" id='cover photo'>
          <Image src="/Example 2.jpg"  width={1000} height={650} alt="Picture of the author" className='object-fit-cover object-position-center position-static mh-25 w-100'/>
            <div className="card bg-secondary carousel-caption p-3 text-start col-lg-4 m-4">
              <h1 className='card-title'>Your best clean!</h1>
              <p className='card-subtitle pb-2'>At Punchclean we provide our customers with worldclass service and happy smiles!</p>
              <p><a className="btn btn-lg btn-primary" href="#">Clean Now!</a></p>
          </div>
        </div>

        <div className="container-fluid" id='gallery'>

          <div className="row featurette pt-4 ms-md-5" id='About Us'>
            ...
            <div className="col-md-5">
              <Image src="/Team Photo.jpeg" width={600} height={600} alt="See the Team" className='featurette-image img-fluid mx-aut'/>
            </div>
          </div> 
        
          <hr className="featurette-divider"></hr>

          <div className="row featurette" id='Why Us?'>
            <div className="col-md-7 order-md-2 d-flex align-items-center">
            <div className={styles.marketingText}>
          ...
          <div className="row featurette pt-4 ms-md-5 " id='Experience the Difference'>
            <div className="col-md-7 d-flex align-items-center">
              <div className={styles.marketingText}>
            ...
            <div className="col-md-5">
              <Image src="/Before and after.jpeg" width={550} height={425} alt="experience the difference" className='ms-sm-5 w-75'/>
            </div>
          </div> 
        ...
        <div id="icon banner " className='bg-secondary pt-1'>
        <div  className={styles.iconBanner}>
          <div className='container-fluid row mt-3'>
            <div className="col-lg-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-globe-asia-australia" viewBox="0 0 16 16">
            ...
            <div className="col-lg-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-currency-dollar" viewBox="0 0 16 16">
              ...
              <form className='m-2'>
                <div className="row g-3">
                  ...
                  <div className="col-sm mt-1 mb-1" id='email'>
                    <label className={styles.textlbl} htmlFor="mail">Email<a className="text-danger fw-bold">*</a></label>
